...
Run a simple agent task using one of the bundled templates:
...
- **FlowMesh** — Apache License 2.0 (see `LICENSE` at the repo root)
- **Youtu-Agent** — Apache License 2.0
