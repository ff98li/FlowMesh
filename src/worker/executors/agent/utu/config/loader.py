...
class ConfigLoader:
    ...
    @classmethod
    def _load_config_to_dict(
        cls, name: str = "default", config_path: str | None = None
    ) -> dict:
        ...
        ret = OmegaConf.to_container(cfg, resolve=True)
        assert isinstance(ret, dict)
        return ret

    # @classmethod
    # def _load_config_to_cls(
    #     cls, name: str, config_type: type[TConfig] = None
    # ) -> TConfig:
    #     # TESTING
