...
class CodesnipToolkit(AsyncBaseToolkit):
    ...
    async def run_code(self, code: str, language: str = "python") -> str:
        ...
        Supported languages: python, cpp, nodejs, go, go_test, java, php, csharp,
        bash, typescript, sql, rust, cuda, lua, R, perl, D_ut, ruby, scala, julia,
        ...
        logger.info(
            ...
            f"got result: {oneline_object(result)}"
        )
        return str(result)
