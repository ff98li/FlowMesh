...
class SerperToolkit(AsyncBaseToolkit):
    ...
    async def google_lens(
        self, url: str, gl: str = "cn", hl: str = "zh-cn", num: int = 10
    ) -> dict[str, Any]:
        """
    ...
    async def map_search(
        ...
        Args:
            ...
            zoom (int | None): Map zoom level.
            place_id (str | None): Google Place ID.
            cid (str | None): Google CID.
    ...
    async def news_search(
        ...
        Args:
            ...
            hl (str): Language code.
            num (int): Number of results.
            date_range (str | None): Time filter.
