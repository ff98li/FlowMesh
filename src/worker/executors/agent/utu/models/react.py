...
class ReactModel(OpenAIChatCompletionsModel):
    ...
    async def get_response(
        ...
        model_response = await super().get_response(
            ...
            model_settings=preprocess_input.model_settings or ModelSettings(),
        )
    ...
    async def stream_response(
        ...
        """
        yield:
            1. All events will be wrapped in RawResponsesStreamEvent(data=event) and
            sent to `_event_queue`
