...
class SQLModelUtils:
    ...
    def _init_db_schema(engine):
        ...
        try:
            ...
            from utu.db import eval_datapoint  # type: ignore # noqa: F401
            from utu.db import tool_cache_model  # type: ignore # noqa: F401
            from utu.db import tracing_model  # type: ignore # noqa: F401
        except Exception as e:
