...
class OpenInferenceTracingProcessor(TracingProcessor):
    ...
    def __init__(self, tracer: Tracer) -> None:
        ...
        # This captures in flight handoff. Once the handoff is complete, the entry is
        # deleted.
...
def _get_attributes_from_input(
    ...
    for i, item in enumerate(obj, msg_idx):
        ...
        if "type" not in item:
            ...
            assert_never(item["type"])  # type: ignore
...
# convert dict, tuple, etc into one of these types
